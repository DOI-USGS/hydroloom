...
The attributes described in this vignette assume that diversions in the network have zero flow such that diversions are treated as if they were headwaters. See the [non-dendritic networks article](https://doi-usgs.github.io/hydroloom/articles/non-dendritic.html) for information about attributes that include connected divergences.
