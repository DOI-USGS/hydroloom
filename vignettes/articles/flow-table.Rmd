...
if (!requireNamespace("hydrogeofetch", quietly = TRUE)) local <- FALSE
if (!requireNamespace("mapview", quietly = TRUE)) local <- FALSE

if (local) {
  hydrogeofetch::hydrogeofetch_data_dir(file.path(tempdir(), "nhd_cache"))
}
...
This article demonstrates how to work with the NHD flow table using hydrogeofetch and hydroloom.
...
dir <- hydrogeofetch::download_nhd(hydrogeofetch::hydrogeofetch_data_dir(),
  "1908", TRUE)
...
unlink(hydrogeofetch::hydrogeofetch_data_dir(), recursive = TRUE)
```
