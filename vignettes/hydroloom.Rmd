...
The "toid" of a terminal flowline can be NA or — by convention — 0 or "". Using 0 or an empty string is preferred within `hydroloom`, but both are handled in most cases. As long as 0 is not in the set of IDs, there is little practical difference.
