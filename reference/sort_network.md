...
potentially split set of output. Sort is from top to bottom so
...
#> Warning: return_dendritic = FALSE is deprecated. Use to_flownetwork() for non-dendritic edge lists.
