...
`hydroloom` was largely created from components of [nhdplusTools](https://doi.org/10.5066/P97AS8JD), which is now published as [hydrogeofetch](https://doi-usgs.github.io/hydrogeofetch/):
...
`hydrogeofetch` supports web service access and the particulars of the NHDPlus
data model. In contrast, `hydroloom` is intended to be more general and focused
